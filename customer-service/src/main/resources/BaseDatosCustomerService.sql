...
CREATE TABLE `customers` (
                             ...
                             CONSTRAINT `FK2wkt5i862ljgauvs6mtjh8d8v` FOREIGN KEY (`person_id`) REFERENCES `persons` (`id`)
...
CREATE TABLE `persons` (
                           ...
                           PRIMARY KEY (`id`),
                           UNIQUE KEY `UK_IDENTIFICATION_NUMBER` (`identification`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'customerdb'
--

--
-- Dumping routines for database 'customerdb'
--
...
-- Dump completed on 2025-12-10 22:22:50
